...
| 제로 표기 없는 당류 음료 제외 | −684건 |
| 제품 단위로 통합한 최종 레코드 | **1,015개** |
| 열량·당류 조인 성공 | 557개 (54.9%) |
| 제품명에 제로 표기 | 325개 |
| └ 그중 **원재료에 당류가 있는 제품** | **22개** |
| 배합 변경 이력이 확인된 제품 | 214개 |
...
수집 대상은 **당류가 없는 음료**와 **제로를 표방한 제품**입니다.
제로 표기가 없는 일반 당류 음료는 제외하므로, **F 티어에는 제로를 내세우고도
신고 원재료에 당류가 있는 제품만** 남습니다.
