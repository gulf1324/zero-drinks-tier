...
| 제로 표기 없는 일반 음료 제외 | −1,075건 |
| 제품 단위로 통합한 최종 레코드 | **624개** |
| 열량·당류 조인 성공 | 417개 (66.8%) |
| 제품명에 제로 표기 | 325개 |
| └ 그중 **원재료에 당류가 있는 제품** | **22개** |
| 배합 변경 이력이 확인된 제품 | 132개 |
...
그 결과 **F 티어에는 제로를 내세우고도 신고 원재료에 당류가 있는 제품만** 남습니다.
...
| 무감미료  | 감미료 표기 없음                | 원재료 전문이 투명하고 감미료가 실제로 없음                                                                | —                                                                                                                                                                                                                                                     |
